...
export const CardsDescubra = () => {
  ...
  const cardsData = [
    { id: 1, imgSrc: "/img/fisica.svg", title: "Atividade e\nEsporte", stars: 3 },
    { id: 2, imgSrc: "/img/marketing-icon.svg", title: "Marketing", stars: 3 },
    { id: 3, imgSrc: "/img/espanhol.svg", title: "Espanhol", stars: 3 },
